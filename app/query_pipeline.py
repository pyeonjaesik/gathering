...
def init_query_pipeline_tables(conn: sqlite3.Connection) -> None:
    ...
    conn.execute(
        ...
        CREATE TABLE IF NOT EXISTS query_image_analysis_cache (
            ...
            orig_w INTEGER,
            orig_h INTEGER,
            orig_est_tokens INTEGER,
            pass2_w INTEGER,
            pass2_h INTEGER,
            pass2_est_tokens INTEGER,
            pass2_resized INTEGER,
            pass3_w INTEGER,
            pass3_h INTEGER,
            pass3_est_tokens INTEGER,
            pass3_resized INTEGER,
...
def upsert_image_analysis_cache(
    ...
    *,
    ...
    orig_est_tokens: int | None = None,
    pass2_w: int | None = None,
    pass2_h: int | None = None,
    pass2_est_tokens: int | None = None,
    pass2_resized: bool | None = None,
    pass3_w: int | None = None,
    pass3_h: int | None = None,
    pass3_est_tokens: int | None = None,
    pass3_resized: bool | None = None,
    ...
    conn.execute(
        ...
        ON CONFLICT(image_url) DO UPDATE SET
            ...
            orig_est_tokens=excluded.orig_est_tokens,
            pass2_w=excluded.pass2_w,
            pass2_h=excluded.pass2_h,
            pass2_est_tokens=excluded.pass2_est_tokens,
            pass2_resized=excluded.pass2_resized,
            pass3_w=excluded.pass3_w,
            pass3_h=excluded.pass3_h,
            pass3_est_tokens=excluded.pass3_est_tokens,
            pass3_resized=excluded.pass3_resized,
        ...
        (
            ...
            int(orig_w) if orig_w is not None else None,
            int(orig_h) if orig_h is not None else None,
            int(orig_est_tokens) if orig_est_tokens is not None else None,
            int(pass2_w) if pass2_w is not None else None,
            int(pass2_h) if pass2_h is not None else None,
            int(pass2_est_tokens) if pass2_est_tokens is not None else None,
            int(pass2_resized) if pass2_resized is not None else None,
            int(pass3_w) if pass3_w is not None else None,
            int(pass3_h) if pass3_h is not None else None,
            int(pass3_est_tokens) if pass3_est_tokens is not None else None,
            int(pass3_resized) if pass3_resized is not None else None,
            resize_policy_code,
